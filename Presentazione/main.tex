...
\logo{
    \begin{picture}(0,0)
        \put(0,0){\makebox(-60,235)[rt]{\includesvg[width=1cm]{images/logos/unibg_logo_single.svg}}}
         \put(0,0){\makebox(-25,235)[rt]{\includegraphics[width=0.7cm]{images/logos/gaps.png}}}
    \end{picture}
}
...
\titlegraphic { 
    \begin{picture}(0,0)
        ...
        \put(25,164){\makebox(0,0)[rt]{\includegraphics[width=4cm]{images/logos/unibg-logo.png}}}
        \put(90,170){\makebox(0,0)[rt]{\includegraphics[width=1.4cm]{images/logos/gaps.png}}}
    \end{picture}
}
    ...
    \begin{columns}
        \column{0.55\textwidth}
            \begin{tabular}{M{3.8cm} M{3cm}}
                \includegraphics[width=3cm]{images/flight_components_validation/FEB_immagine.pdf} & \shortstack{\textbf{Front-end board}\vspace{0.15cm} \\ 300 tested\vspace{0.15cm}\\ bias, digital and analog\\tested with dedicated test\\ setup and software} \\\vspace{0.5cm}
                \includegraphics[width=3.8cm]{images/flight_components_validation/dummy_image.pdf} & \shortstack{\textbf{Dummy-1}\\ \textbf{front-end board}\vspace{0.15cm} \\ 70 assembled and tested\vspace{0.15cm}\\not populated board\\emulate thermal\\ behaviour of the\\ front-end board}
            \end{tabular}       
        \column{0.45\textwidth}
            \begin{tabular}{M{3cm} M{2.5cm}}
                \includegraphics[width=3cm]{images/flight_components_validation/flex_rigid_pic.pdf} & \shortstack{\textbf{Flex-rigid board}\vspace{0.15cm} \\ 250 tested} \\\vspace{0.5cm}
                \includegraphics[width=3cm]{images/flight_components_validation/term_conn.pdf} & \shortstack{\textbf{Connector for}\\ \textbf{termination}\vspace{0.15cm} \\ 60 tested} \\\vspace{0.5cm}
                \includegraphics[width=3cm]{images/flight_components_validation/shieldsPDFtwo.pdf} & \shortstack{\textbf{Front-end board}\\ \textbf{shields}\vspace{0.15cm} \\ 270 tested\\per type}
            \end{tabular}     
    \end{columns}
\end{frame}
...
\begin{frame}{Si(Li) tracker flight components validation}
    ...
    \begin{columns}
        ...
        \begin{enumerate}
            ...
            \item An item \textbf{report} with test results has been generated
    ...
    \begin{columns}
        \column{0.53\textwidth}
            ...
            \begin{itemize}
                ...
                \item Si(Li) detectors biased at \textbf{\SI{-250}{\volt}} using a \textit{CAEN HiVolta} high voltage power supply
                \item Purposely developed Python script employed to acquire data from readout electronics using an FPGA
            \end{itemize}
        \column{0.43\textwidth}
            \includegraphics[width=0.95\textwidth]{images/muon_detection/foto_modulo_camera.pdf}
            \vspace{0.2cm}
            \begin{columns}
                \column{0.5\textwidth}
                ...
                \column{0.5\textwidth}
                    \begin{itemize}
                        \item External trigger for\\ cosmic muon detection provided\\ by \textit{ArduSiPM} radiation detector\vspace{0.1cm}
...
\begin{frame}{X-ray detection with \ce{^{241}Am} source}
    ...
    \fontsize{8.5pt}{1}\selectfont
    \vspace{0.2cm}
    \begin{tabular}{R{3cm} L{5.8cm} L{5cm}}
         ...
         & emits $\gamma$ radiation at \textbf{\SI{59.54}{\kilo\electronvolt}} and \textbf{\SI{26.34}{\kilo\electronvolt}}
    \end{tabular}
\end{frame}
...
\begin{frame}{Cosmic muon detection with external scintillator}
    ...
    \begin{columns}
        ...
        \begin{itemize}
            ...
            \vskip0.4cm
            \includegraphics[width=1\textwidth]{images/muon_detection/scintillator_sensor_detail.png}
            \vskip0.4cm
        ...
        \column{0.65\textwidth}
            ...
            \begin{figure}[h!]
                \centering
                \begin{tabular}{c c}
                    \includegraphics[width=0.44\textwidth]{images/muon_detection/incoming_energy34_2hr_sens2_keV.pdf} & \includegraphics[width=0.44\textwidth]{images/muon_detection/incoming_energy34_2hr_sens3_keV.pdf}\B \\
                    \includegraphics[width=0.44\textwidth]{images/muon_detection/incoming_energy34_2hr_sens1_keV.pdf} & \includegraphics[width=0.44\textwidth]{images/muon_detection/incoming_energy34_2hr_sens4_keV.pdf}
                \end{tabular}
            \end{figure}
    \end{columns}
\end{frame}
